...
- 2026-01-03: Status → Planned; handed off to plan doc.
...
- Several domain models (Task, Quest, BattleSettings, WeatherStore, AIInsightRecord) may have evolved without synchronized type updates in dependent modules and tests, producing property-not-found errors.
