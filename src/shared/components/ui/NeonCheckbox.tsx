...
export function NeonCheckbox({
    ...
    // Generate a unique ID for the style tag to avoid conflicts if multiple instances exist (though styles are scoped by class)
    // In this case, the class names are specific enough (.neon-checkbox)
    ...
    return (
      ...
      `}</style>
            ...
            <label className={`neon-checkbox ${className}`}>
