...
const GEMINI_API_ENDPOINT = 'https://generativelanguage.googleapis.com/v1beta/models/gemini-3.0-flash:streamGenerateContent';
...
- 작업: "리액트 공부하기" -> "강의 영상 켜고, 딱 3분만 멍하니 화면만 쳐다봐도 성공이에요!"
- 작업: "운동하기" -> "운동복으로 갈아입기만 해요. 그리고 다시 누워도 돼요!"
- 작업: "보고서 쓰기" -> "새 문서 열고 제목에 '멍멍'이라고 쓰고 3분 동안 감상해봐요."
